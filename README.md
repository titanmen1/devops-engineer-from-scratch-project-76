...
Приложение развёрнуто и доступно по доменному имени:
**http://hexlet-third-project.crabdance.com/**
...
_HTTPS пока не настроен; для https нужен TLS-сертификат на домен и
терминирование TLS на балансировщике._
